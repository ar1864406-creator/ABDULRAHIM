...
export function Header() {
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl">
      <div className="glass-card rounded-2xl px-6 h-20 flex items-center justify-between border-white/5 shadow-2xl backdrop-blur-md">
              ...
              <SheetContent side="right" className="bg-background/95 backdrop-blur-xl border-white/10 w-[300px]">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-4 pt-8 border-t border-white/5">
                    <Button variant="outline" className="w-full border-white/10 glass-morphism text-white h-12 rounded-xl">
                      Log In
                    </Button>
