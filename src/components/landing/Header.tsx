...
export function Header() {
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-fit group">
      <div className="flex items-center gap-12 bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-full px-8 py-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] ring-1 ring-white/10 transition-all duration-500 hover:bg-white/[0.06] hover:border-white/20 hover:scale-[1.02]">
