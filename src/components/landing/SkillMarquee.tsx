...
export function SkillMarquee() {
  return (
    <div className="relative w-full py-12 overflow-hidden bg-background/30 border-y border-white/5 backdrop-blur-sm">
      ...
      <div className="flex animate-marquee whitespace-nowrap">
        ...
        {[...marqueeSkills, ...marqueeSkills].map((skill, index) => (
          <div 
            key={index} 
            className="flex items-center gap-3 mx-10 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 text-muted-foreground hover:text-primary hover:border-primary/30 transition-all duration-300"
          >
