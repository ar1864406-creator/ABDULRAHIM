...
import { Zap, Activity, Server, ShieldCheck, ChevronUp, ChevronDown } from 'lucide-react'
...
export function PerformanceWidget() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] perspective-container">
      <div 
        className={cn(
          "clay-card transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] overflow-hidden card-3d",
          isExpanded ? "w-64 p-6" : "w-16 h-16 p-0 flex items-center justify-center cursor-pointer"
        )}
